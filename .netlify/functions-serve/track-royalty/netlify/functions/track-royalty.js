...
// netlify/functions/track-royalty.js
...
exports.handler = async (event) => {
  ...
  const artistSplit = 0.7;
  const labelSplit = 0.3;
  const splits = {
  ...
  trackEarningsDB[email].push({ trackName, revenue, splits, date: (/* @__PURE__ */ new Date()).toISOString() });
  return { statusCode: 200, body: JSON.stringify({ success: true, splits }) };
};
//# sourceMappingURL=track-royalty.js.map
